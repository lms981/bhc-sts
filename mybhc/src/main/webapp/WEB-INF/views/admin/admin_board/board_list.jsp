...
$(document).ready(function() {
    for (i = 1; i <= 6; i++) {
       $('#faq-ui' + i).click(function() {
          $(this).find('.blind').slideToggle();
       });
    }
 });//ready
</script>
				...
				<div class="faq_cont">
					<ul class="faq-ui">
						<li>
							...
							<div><span class="blind">답변</span>당사에서 사용중인 원료육은 닭고기의 Golden zone 에 해당하는 국내산 10호(중량 951~1050g) 크기의 재료만 사용하고 있습니다. 10호 닭은 육즙이 풍부하고 부드러우며 쫄깃한 질감이 살아있어 최상의 맛을 느낄수 있지만 , 개체의 발육상태 또는 부분발육상태(다리, 날개 등)에 따라 오차범위내의 무게차이가 발생 할 수 있습니다. 또한 조리가 진행되면서 유,수분의 증발로 인해 중량차이가 발생합니다.</div>
						</li>
						<li>
							<button><span class="blind">질문</span>치킨속살이 빨개요. 안익은 건가요?</button>
							<div style="display:none;"><span class="blind">답변</span>닭고기를 포함하여 육류의 근육세포내 미오글로빈이라는 단백질 성분이 있습니다. <br>        해당 성분이 열과 산소를 만나면 속살이 붉게 나타나는 "핑킹현상" 으로 안심하고 드셔도 무방합니다. 그러나 덜익은 제품으로 의심이 될 경우 제품사진과 함께 문의 주시면 현물 검수를 통해 정확히 안내 도와드리도록 하겠습니다.</div>
						</li>
						<li>
